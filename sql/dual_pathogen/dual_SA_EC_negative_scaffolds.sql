-- ====================================================================================
-- QUERY 1: Dual S. aureus + E. coli Negative Scaffolds
-- ====================================================================================

-- Dual Pathogen Negative Scaffolds Analysis: S. aureus + E. coli (Using Reliable Compounds)
-- Scaffolds present in S. aureus AND E. coli but NOT in C. albicans
...
SELECT 
    'NEGATIVE SCAFFOLDS' as query_type,
    ass.rank,
    ass.fragment_id,
    ass.fragment_smiles,
...
GROUP BY ass.rank, ass.fragment_id, ass.fragment_smiles, ass.pathogen_count,
         ...
         ass.overall_avg_attribution, ass.overall_min_attribution, ass.avg_inactivity_rate_percent
ORDER BY ass.rank;