-- ====================================================================================
-- SUMMARY 2: Dual S. aureus + C. albicans Positive substituents Summary
-- ====================================================================================
...
top_substituents AS (
    SELECT 
        COUNT(CASE WHEN total_tp_count >= 20 THEN 1 END) as substituents_with_20plus_tp,   -- 10+ per pathogen
        COUNT(CASE WHEN total_tp_count >= 40 THEN 1 END) as substituents_with_40plus_tp,   -- 20+ per pathogen
        COUNT(CASE WHEN total_tp_count >= 100 THEN 1 END) as substituents_with_100plus_tp, -- 50+ per pathogen
...
SELECT 
    'Dual S.aureus + C.albicans Positive substituents Summary (Reliable Compounds Only)' as analysis_type,
    ...
    ROUND((ts.substituents_high_attribution::numeric / os.total_dual_substituents * 100), 1) as pct_substituents_high_attribution,
