-- ====================================================================================
-- QUERY 2: Dual S. aureus + E. coli Positive Scaffolds
-- ====================================================================================

-- Dual Pathogen Positive Scaffolds Analysis: S. aureus + E. coli (Using Reliable Compounds)
...
SELECT 
    'POSITIVE SCAFFOLDS' as query_type,
    ass.rank,
    ass.fragment_id,
    ass.fragment_smiles,
