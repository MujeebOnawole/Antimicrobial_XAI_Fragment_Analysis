-- ====================================================================================
-- QUERY 3: Dual S. aureus + E. coli Negative Substituents
-- ====================================================================================

-- Dual Pathogen Negative Substituents Analysis: S. aureus + E. coli (Using Reliable Compounds)
...
SELECT 
    'NEGATIVE SUBSTITUENTS' as query_type,
    ass.rank,
    ass.fragment_id,
    ass.fragment_smiles,
