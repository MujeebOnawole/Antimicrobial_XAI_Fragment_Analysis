-- ====================================================================================
-- QUERY 5: Dual S. aureus + E. coli Negative Scaffolds Summary
-- ====================================================================================
...
dual_specific_negative_scaffolds AS (
    ...
    WHERE fragment_id NOT IN (SELECT fragment_id FROM c_albicans_scaffolds)
),
...
top_scaffolds AS (
    SELECT 
        COUNT(CASE WHEN total_tn_count >= 20 THEN 1 END) as scaffolds_with_20plus_tn,
        COUNT(CASE WHEN total_tn_count >= 40 THEN 1 END) as scaffolds_with_40plus_tn,
        COUNT(CASE WHEN total_tn_count >= 100 THEN 1 END) as scaffolds_with_100plus_tn,
...
SELECT 
    'Dual S.aureus + E.coli Negative Scaffolds Summary (Reliable Compounds Only)' as analysis_type,
