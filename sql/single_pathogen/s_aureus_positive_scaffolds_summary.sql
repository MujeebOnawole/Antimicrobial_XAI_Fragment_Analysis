-- Summary Statistics for S. aureus Specific Positive Scaffolds (Using Reliable Compounds)
...
SELECT 
    'S. aureus Specific Positive Scaffolds Summary (Reliable Compounds Only)' as analysis_type,
