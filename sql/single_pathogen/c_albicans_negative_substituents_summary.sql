-- Summary Statistics for C. albicans Specific Negative Substituents (Using Reliable Compounds)
...
SELECT 
    'C. albicans Specific Negative Substituents Summary (Reliable Compounds Only)' as analysis_type,
