-- Summary Statistics for C. albicans Specific Negative Scaffolds (Using Reliable Compounds)
...
SELECT 
    'C. albicans Specific Negative Scaffolds Summary (Reliable Compounds Only)' as analysis_type,
