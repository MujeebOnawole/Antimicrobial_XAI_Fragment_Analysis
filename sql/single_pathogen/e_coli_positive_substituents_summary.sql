-- Summary Statistics for E. coli Specific Positive Substituents (Using Reliable Compounds)
...
SELECT 
    'E. coli Specific Positive Substituents Summary (Reliable Compounds Only)' as analysis_type,
