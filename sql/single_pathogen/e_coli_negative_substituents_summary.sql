-- Summary Statistics for E. coli Specific Negative Substituents (Using Reliable Compounds)
...
SELECT 
    'E. coli Specific Negative Substituents Summary (Reliable Compounds Only)' as analysis_type,
