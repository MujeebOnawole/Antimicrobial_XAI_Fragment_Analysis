-- Summary Statistics for C. albicans Specific Positive Scaffolds (Using Reliable Compounds)
...
SELECT 
    'C. albicans Specific Positive Scaffolds Summary (Reliable Compounds Only)' as analysis_type,
