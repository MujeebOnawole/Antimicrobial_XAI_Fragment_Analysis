-- Summary Statistics for C. albicans Specific Positive Substituents (Using Reliable Compounds)
...
SELECT 
    'C. albicans Specific Positive Substituents Summary (Reliable Compounds Only)' as analysis_type,
