-- Summary Statistics for S. aureus Specific Negative Scaffolds (Using Reliable Compounds)
...
SELECT 
    'S. aureus Specific Negative Scaffolds Summary (Reliable Compounds Only)' as analysis_type,
